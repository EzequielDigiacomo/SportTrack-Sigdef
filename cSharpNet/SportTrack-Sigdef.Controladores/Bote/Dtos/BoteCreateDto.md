...
**Archivo fuente:** `SportTrack-Sigdef.Controladores/Bote/Dtos/BoteCreateDto.cs`
...
- `Tipo` (`string`) — atributos: `[Required]`
...
- Ruta relativa en el proyecto: `Bote/Dtos/BoteCreateDto.cs`.
