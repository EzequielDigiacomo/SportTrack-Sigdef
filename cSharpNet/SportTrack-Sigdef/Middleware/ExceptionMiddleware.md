...
> Fuente: `SportTrack-Sigdef/Middleware/ExceptionMiddleware.cs`

## Que es este archivo

Archivo C# del proyecto **SportTrack-Sigdef**. Define: `ExceptionMiddleware` (tipo principal: **class**).
...
- `SportTrack_Sigdef.Controladores.Exceptions`
- `System.Net`
- `System.Text.Json`
...
|--------|---------|------------|-------|
| `InvokeAsync` | `Task` | `HttpContext context, IAuditService auditService` | Si |
| `ApplyCorsHeaders` | `void` | `HttpContext context` | No |
| `GetFullInnerException` | `string?` | `Exception ex` | No |
