...
**Archivo fuente:** `SportTrack-Sigdef.Controladores/Federaciones/DTOs/Inscripcion/InscripcionCreateDto.cs`
...
- `ParticipanteId` (`int`) — atributos: `[Required(ErrorMessage = "El ID del AtletaFederacion es requerido")]`
- `IdEventoPrueba` (`int`) — atributos: `[Required(ErrorMessage = "El ID de la prueba es requerido")]`
...
- Ruta relativa en el proyecto: `Federaciones/DTOs/Inscripcion/InscripcionCreateDto.cs`.
