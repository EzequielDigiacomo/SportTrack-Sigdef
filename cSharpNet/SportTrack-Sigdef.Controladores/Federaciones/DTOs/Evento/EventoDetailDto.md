...
**Archivo fuente:** `SportTrack-Sigdef.Controladores/Federaciones/DTOs/Evento/EventoDetailDto.cs`
...
- `Pruebas` (`List<EventoPrueba.EventoPruebaDto>`)
...
- Ruta relativa en el proyecto: `Federaciones/DTOs/Evento/EventoDetailDto.cs`.
