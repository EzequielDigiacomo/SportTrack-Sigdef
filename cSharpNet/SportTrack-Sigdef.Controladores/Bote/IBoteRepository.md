...
**Archivo fuente:** `SportTrack-Sigdef.Controladores/Bote/IBoteRepository.cs`
...
- **Firma:** `Task<IEnumerable<Entidades.Entidades.Bote>> GetAllAsync()`
- **Retorno:** `Task<IEnumerable<Entidades.Entidades.Bote>>`
- **Parámetros:**
...
- **Firma:** `Task<Entidades.Entidades.Bote?> GetByIdAsync(int id)`
- **Retorno:** `Task<Entidades.Entidades.Bote?>`
- **Parámetros:**
...
- **Firma:** `Task<Entidades.Entidades.Bote> CreateAsync(Entidades.Entidades.Bote bote)`
- **Retorno:** `Task<Entidades.Entidades.Bote>`
- **Parámetros:**

- `bote` (`Entidades.Entidades.Bote`)

- **Qué hace:** declara el contrato; la implementación concreta está en la clase que implementa la interfaz.

#### `UpdateAsync`

- **Firma:** `Task<Entidades.Entidades.Bote> UpdateAsync(Entidades.Entidades.Bote bote)`
- **Retorno:** `Task<Entidades.Entidades.Bote>`
- **Parámetros:**
...
- Ruta relativa en el proyecto: `Bote/IBoteRepository.cs`.
