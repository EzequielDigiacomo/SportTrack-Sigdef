...
> Fuente: `SportTrack-Sigdef.Entidades/Entidades/CampanaEnvio.cs`

## Que es este archivo

Archivo C# del proyecto **SportTrack-Sigdef.Entidades**. Define: `CampanaEnvio` (tipo principal: **class**).
...
|-----------|------|-------|
| `IdCampana` | `int` | No-null (segun anotaciones) |
| `RemitenteId` | `int` | No-null (segun anotaciones) |
| `Remitente` | `Usuario?` | Puede ser null |
| `Asunto` | `string` | No-null (segun anotaciones) |
| `Cuerpo` | `string` | No-null (segun anotaciones) |
| `EnviadoEn` | `DateTime` | No-null (segun anotaciones) |
| `CantidadDestinatarios` | `int` | No-null (segun anotaciones) |
| `TipoCampana` | `string` | No-null (segun anotaciones) |
| `SistemaOrigen` | `string` | No-null (segun anotaciones) |
| `Hilos` | `ICollection<Hilo>` | No-null (segun anotaciones) |
