# EventoPruebaCreateDto

**Archivo fuente:** `SportTrack-Sigdef.Controladores/Federaciones/DTOs/EventoPrueba/EventoPruebaCreateDto.cs`
...
- `IdEvento` (`int`)
- `IdPrueba` (`int`) — atributos: `[Required(ErrorMessage = "La distancia es requerida")]`
...
- Ruta relativa en el proyecto: `Federaciones/DTOs/EventoPrueba/EventoPruebaCreateDto.cs`.
