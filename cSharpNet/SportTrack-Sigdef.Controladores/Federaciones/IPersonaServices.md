...
**Archivo fuente:** `SportTrack-Sigdef.Controladores/Federaciones/IPersonaServices.cs`
...
- **Firma:** `Task<ActionResult<PersonaDetailDto>> GetPersona(int id)`
...
- **Firma:** `Task<ActionResult<IEnumerable<PersonaDto>>> GetPersonas()`
...
- **Firma:** `Task<ActionResult<PersonaDto>> GetPersonaByDocumento(string documento)`
...
- **Firma:** `Task<ActionResult<PersonaDto>> PostPersona(PersonaCreateDto personaCreateDto)`
- **Retorno:** `Task<ActionResult<PersonaDto>>`
- **Parámetros:**
...
- **Firma:** `Task<IActionResult> PutPersona(int id, PersonaCreateDto personaCreateDto)`
...
- **Firma:** `Task<IActionResult> DeletePersona(int id)`
- **Retorno:** `Task<IActionResult>`
- **Parámetros:**
...
- Ruta relativa en el proyecto: `Federaciones/IPersonaServices.cs`.
