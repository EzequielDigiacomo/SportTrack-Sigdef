...
**Archivo fuente:** `SportTrack-Sigdef.Controladores/Federaciones/DTOs/Evento/DistanciaDto.cs`
...
- `DistanciaRegata` (`DistanciaRegata`)
- `CategoriaEdad` (`int`)
- `TipoBote` (`int`)
- `SexoCompetencia` (`int`)
- `Descripcion` (`string`)
...
- Ruta relativa en el proyecto: `Federaciones/DTOs/Evento/DistanciaDto.cs`.
