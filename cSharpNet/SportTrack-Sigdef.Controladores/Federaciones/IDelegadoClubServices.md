# IDelegadoClubServices

**Archivo fuente:** `SportTrack-Sigdef.Controladores/Federaciones/IDelegadoClubServices.cs`
...
- **Firma:** `Task<ActionResult<DelegadoClubDetailDto>> GetDelegadoClub(int id)`
...
- **Firma:** `Task<ActionResult<IEnumerable<DelegadoClubDto>>> GetDelegadosClub()`
...
- **Firma:** `Task<ActionResult<IEnumerable<DelegadoClubDto>>> GetDelegadosPorFederacion(int idFederacion)`
- **Retorno:** `Task<ActionResult<IEnumerable<DelegadoClubDto>>>`
- **Parámetros:**
...
- **Firma:** `Task<ActionResult<DelegadoClubDto>> PostDelegadoClub(DelegadoClubCreateDto delegadoClubCreateDto)`
...
- **Firma:** `Task<IActionResult> PutDelegadoClub(int id, DelegadoClubCreateDto delegadoClubCreateDto)`
...
- **Firma:** `Task<IActionResult> DeleteDelegadoClub(int id)`
- **Retorno:** `Task<IActionResult>`
- **Parámetros:**
...
- Ruta relativa en el proyecto: `Federaciones/IDelegadoClubServices.cs`.
