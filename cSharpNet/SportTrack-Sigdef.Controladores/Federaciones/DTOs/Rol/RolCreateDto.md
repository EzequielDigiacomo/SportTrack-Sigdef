...
**Archivo fuente:** `SportTrack-Sigdef.Controladores/Federaciones/DTOs/Rol/RolCreateDto.cs`
...
- `Tipo` (`string`) — atributos: `[Required(ErrorMessage = "El tipo de rol es requerido")]`, `[MaxLength(50, ErrorMessage = "El tipo de rol no puede exceder 50 caracteres")]`
...
- Ruta relativa en el proyecto: `Federaciones/DTOs/Rol/RolCreateDto.cs`.
