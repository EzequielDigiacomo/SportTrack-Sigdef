...
**Archivo fuente:** `SportTrack-Sigdef.Controladores/Federaciones/DTOs/Usuario/UsuarioUpdateDto.cs`
...
- `Username` (`string?`) — atributos: `[MaxLength(50, ErrorMessage = "El nombre de usuario no puede exceder 50 caracteres")]`
- `EstaActivo` (`bool?`)
- `RolFederacion` (`RolTipo?`)
- `IdClub` (`int?`)
...
- Ruta relativa en el proyecto: `Federaciones/DTOs/Usuario/UsuarioUpdateDto.cs`.
