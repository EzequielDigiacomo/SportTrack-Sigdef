...
namespace SportTrack_Sigdef.Controladores.Evento
{
    ...
    {
        Task<IEnumerable<Entidades.Entidades.Evento>> GetAllAsync(int? clubId = null, string? rol = null, int? federacionId = null);
    ...
    {
        Task<IEnumerable<EventoDto>> GetAllEventosAsync(int? clubId = null, string? rol = null, int? federacionId = null);
