...
> Fuente: `SportTrack-Sigdef.Entidades/Entidades/MensajeriaSistemaOrigen.cs`

## Que es este archivo

Archivo C# del proyecto **SportTrack-Sigdef.Entidades**. Define: `MensajeriaSistemaOrigen` (tipo principal: **class**).
...
|--------|---------|------------|-------|
| `EsValido` | `bool` | `string? valor` | No |
| `Normalizar` | `string` | `string? clientApp` | No |
