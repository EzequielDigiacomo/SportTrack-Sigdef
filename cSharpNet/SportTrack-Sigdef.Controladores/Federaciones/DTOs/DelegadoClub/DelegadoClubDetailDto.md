# DelegadoClubDetailDto

**Archivo fuente:** `SportTrack-Sigdef.Controladores/Federaciones/DTOs/DelegadoClub/DelegadoClubDetailDto.cs`
...
- `RolFederacion` (`RolDto?`)
- `Federacion` (`FederacionDto?`)
- `Club` (`ClubDto?`)
...
- Ruta relativa en el proyecto: `Federaciones/DTOs/DelegadoClub/DelegadoClubDetailDto.cs`.
