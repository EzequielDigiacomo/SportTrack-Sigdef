...
**Archivo fuente:** `SportTrack-Sigdef.Controladores/Federaciones/DTOs/Tutor/TutorDetailDto.cs`
...
- `AtletasTutores` (`List<AtletaTutorDto>?`)
...
- Ruta relativa en el proyecto: `Federaciones/DTOs/Tutor/TutorDetailDto.cs`.
