...
**Archivo fuente:** `SportTrack-Sigdef.Controladores/Federaciones/DTOs/Tutor/TutorCreateDto.cs`
...
- `TipoTutor` (`string`) — atributos: `[Required(ErrorMessage = "El tipo de tutor es requerido")]`, `[MaxLength(50, ErrorMessage = "El tipo de tutor no puede exceder 50 caracteres")]`
...
- Ruta relativa en el proyecto: `Federaciones/DTOs/Tutor/TutorCreateDto.cs`.
