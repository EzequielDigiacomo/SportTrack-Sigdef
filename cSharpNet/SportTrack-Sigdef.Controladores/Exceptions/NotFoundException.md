...
**Archivo fuente:** `SportTrack-Sigdef.Controladores/Exceptions/NotFoundException.cs`
...
#### Constructor 1: `NotFoundException(...)`
...
- Ruta relativa en el proyecto: `Exceptions/NotFoundException.cs`.
