...
**Archivo fuente:** `SportTrack-Sigdef.Controladores/Federaciones/DTOs/DocumentoUploadDto.cs`
...
- Ruta relativa en el proyecto: `Federaciones/DTOs/DocumentoUploadDto.cs`.
