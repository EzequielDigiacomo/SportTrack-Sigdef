...
> Fuente: `SportTrack-Sigdef/Controllers/DiagnosticController.cs`

## Que es este archivo

Archivo C# del proyecto **SportTrack-Sigdef**. Define: `DiagnosticController` (tipo principal: **class**).
...
- `[HttpGet("check-eventos")]` - Endpoint HTTP GET (lectura).
- `[HttpGet("search/{query}")]` - Endpoint HTTP GET (lectura).
...
|--------|---------|------------|-------|
| `CheckEventos` | `Task<IActionResult>` | `-` | Si |
| `Search` | `Task<IActionResult>` | `string query` | Si |
