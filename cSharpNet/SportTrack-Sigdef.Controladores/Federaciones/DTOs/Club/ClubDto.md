...
**Archivo fuente:** `SportTrack-Sigdef.Controladores/Federaciones/DTOs/Club/ClubDto.cs`
...
- `Siglas` (`string`)
- `IdFederacion` (`int?`)
- `EstadoMatricula` (`SportTrack_Sigdef.Entidades.Enums.EstadoPago`)
- `TieneDelegado` (`bool`)
- `CantidadAtletas` (`int`)
- `CantidadEntrenadores` (`int`)
- `CantidadRepresentantes` (`int`)
...
- Ruta relativa en el proyecto: `Federaciones/DTOs/Club/ClubDto.cs`.
