...
**Archivo fuente:** `SportTrack-Sigdef.Controladores/Distancia/Dtos/DistanciaCreateDto.cs`
...
- `DistanciaRegata` (`DistanciaRegataEnum`) — atributos: `[Required]`
- `GapSugerido` (`int`)
...
- Ruta relativa en el proyecto: `Distancia/Dtos/DistanciaCreateDto.cs`.
