...
**Archivo fuente:** `SportTrack-Sigdef.Controladores/Federaciones/DTOs/Evento/DistanciaOptionDto.cs`
...
- `IdDistanciaEnum` (`int`)
- `CodigoDistanca` (`string`)
- `NombreDistancias` (`string`)
- `Metros` (`decimal`)
...
- Ruta relativa en el proyecto: `Federaciones/DTOs/Evento/DistanciaOptionDto.cs`.
