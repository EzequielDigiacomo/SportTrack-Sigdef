...
> Fuente: `SportTrack-Sigdef/Controllers/BackupController.cs`

## Que es este archivo

Archivo C# del proyecto **SportTrack-Sigdef**. Define: `BackupController` (tipo principal: **class**).
...
- `[HttpGet("download")]` - Endpoint HTTP GET (lectura).
...
|--------|---------|------------|-------|
| `DownloadBackup` | `Task<IActionResult>` | `-` | Si |
