...
**Archivo fuente:** `SportTrack-Sigdef.Controladores/Federaciones/DTOs/Club/ClubDetailDto.cs`
...
- `AtletasFederados` (`List<AtletaDto>?`)
- `Entrenadores` (`List<EntrenadorDto>?`)
- `Representantes` (`List<DelegadoClubDto>?`)
...
- Ruta relativa en el proyecto: `Federaciones/DTOs/Club/ClubDetailDto.cs`.
