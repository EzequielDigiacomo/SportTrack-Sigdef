...
**Archivo fuente:** `SportTrack-Sigdef.Controladores/Federaciones/DTOs/Evento/EventoDto.cs`
...
- `FechaFin` (`DateTime`)
- `CantidadInscripciones` (`int`)
- `TotalAtletas` (`int`)
- `TotalClubes` (`int`)
- `Estado` (`string`)
- `Pruebas` (`List<EventoPruebaDto>`)
...
- Ruta relativa en el proyecto: `Federaciones/DTOs/Evento/EventoDto.cs`.
