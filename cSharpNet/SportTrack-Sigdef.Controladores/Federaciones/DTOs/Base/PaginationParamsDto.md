...
**Archivo fuente:** `SportTrack-Sigdef.Controladores/Federaciones/DTOs/Base/PaginationParamsDto.cs`
...
- `_pageSize` — tipo `int` (típicamente dependencia inyectada o estado privado)
...
- Ruta relativa en el proyecto: `Federaciones/DTOs/Base/PaginationParamsDto.cs`.
