...
> Fuente: `SportTrack-Sigdef/Security/TokenKeyResolver.cs`

## Que es este archivo

Archivo C# del proyecto **SportTrack-Sigdef**. Define: `TokenKeyResolver` (tipo principal: **class**).
...
- **Options / Configuration**: lee settings desde appsettings.json.

## Namespace

```
SportTrack_Sigdef.Security
```
...
|--------|---------|------------|-------|
| `Resolve` | `string` | `IConfiguration config, IHostEnvironment env` | No |
