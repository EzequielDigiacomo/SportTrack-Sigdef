...
**Archivo fuente:** `SportTrack-Sigdef.Controladores/Categoria/ICategoriaRepository.cs`
...
- **Firma:** `Task<IEnumerable<Entidades.Entidades.Categoria>> GetAllAsync()`
- **Retorno:** `Task<IEnumerable<Entidades.Entidades.Categoria>>`
- **Parámetros:**
...
- **Firma:** `Task<Entidades.Entidades.Categoria?> GetByIdAsync(int id)`
- **Retorno:** `Task<Entidades.Entidades.Categoria?>`
- **Parámetros:**
...
- **Firma:** `Task<Entidades.Entidades.Categoria> CreateAsync(Entidades.Entidades.Categoria categoria)`
- **Retorno:** `Task<Entidades.Entidades.Categoria>`
- **Parámetros:**

- `categoria` (`Entidades.Entidades.Categoria`)

- **Qué hace:** declara el contrato; la implementación concreta está en la clase que implementa la interfaz.

#### `UpdateAsync`

- **Firma:** `Task<Entidades.Entidades.Categoria> UpdateAsync(Entidades.Entidades.Categoria categoria)`
- **Retorno:** `Task<Entidades.Entidades.Categoria>`
- **Parámetros:**
...
- **Firma:** `Task<IEnumerable<Entidades.Entidades.Categoria>> GetByEdadAsync(int edad)`
- **Retorno:** `Task<IEnumerable<Entidades.Entidades.Categoria>>`
- **Parámetros:**
...
- Ruta relativa en el proyecto: `Categoria/ICategoriaRepository.cs`.
